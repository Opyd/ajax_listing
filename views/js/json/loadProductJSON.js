function back() {
  ...
  sort = document.getElementById("priceSort").hidden = false;
  container.innerHTML = cache;
}

function test(i) {
  document.getElementById("priceSort").hidden = true;
  let container = document.getElementById("container");
  container.innerHTML = `<button onclick='back()' class="bg-green-300 rounded-lg col-span-full">Reset</button>`;
  let objectHTML = `
